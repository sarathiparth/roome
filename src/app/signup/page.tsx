      ...
      >
        ...
        >
          ...
          <div className="space-y-1.5">
            ...
            <p className="text-white/45 text-sm">Find your perfect flatmate, smarter.</p>
          </div>

          {/* Form */}
          <form onSubmit={handleSignup} className="flex flex-col gap-4">
            <div className="space-y-1.5">
              <label className="text-[11px] uppercase tracking-wider text-white/40 font-medium">Full Name</label>
